...
const AccessibilityScanner = () => {
  ...
  const handleScan = async () => {
    ...
    try {
      ...
      // Save to Supabase
      const { data, error } = await scannerHelpers.createScan(scanData);
      ...
      toast({
        title: "Scan Failed",
        description: error.message || "Unable to scan the website. Please check the URL and try again.",
        variant: "destructive",
      });
    } finally {
      setIsScanning(false);
        ...
        <div className="container-tight mx-auto px-6 py-20">
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto leading-relaxed opacity-95">
              Check your website for accessibility issues and get actionable recommendations
            </p>
          </div>
